...
public class UniqueMorseCodeWords {
    ...
    public int uniqueMorseRepresentations(String[] words) {
        ...
        Arrays.stream(words)
                .forEach(w -> result.add(convertToMorseRepresentation(w)));
        return result.size();
    }

    private String convertToMorseRepresentation(String word) {
    ...
    public static void main(String[] args) {
        ...
        UniqueMorseCodeWords calculator = new UniqueMorseCodeWords();
        System.out.println(calculator.uniqueMorseRepresentations(words));
    }
}
